                ...
                success: function(resp) {
                    ...
                    let result = `<div class="intro-y col-span-12 md:col-span-6 xl:col-span-4 box">
                        <div class="flex items-center border-b border-gray-200 px-5 py-4">
                            <div class="mr-auto">
                                <a href="`+url_lokal+`/images/piagam/generate/`+resp.data+`" download class="button bg-theme-1 text-white font-medium">Download</a> 
                            </div>
                        </div>
                        <div class="p-5">
                            <img alt="Generate" class="rounded-md" src="`+url_lokal+`/images/piagam/generate/`+resp.data+`">
                        </div>
                        <hr>
                    </div>`;
