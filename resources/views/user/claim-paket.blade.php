...
<div class="mt-5">
    <a href="{{ url('/claim-data-paket/cetak-alamat') }}" target="_blank" rel="noopener noreferrer" class="mr-3 button w-100 inline-block bg-theme-1 text-white">Cetak Semua Alamat</a>
